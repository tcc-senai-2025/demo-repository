...
CREATE TABLE `carrinho` (
  ...
  PRIMARY KEY (`id`),
  KEY `Carrinho_clienteId_fkey` (`clienteId`),
  KEY `Carrinho_produtoId_fkey` (`produtoId`),
  KEY `Carrinho_tamanhoId_fkey` (`tamanhoId`),
  ...
  CONSTRAINT `Carrinho_tamanhoId_fkey` FOREIGN KEY (`tamanhoId`) REFERENCES `tamanho` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `carrinho` VALUES (17,5,115,1,'2025-12-02 14:25:11.729',NULL),(18,5,116,1,'2025-12-02 14:25:50.507',NULL);
